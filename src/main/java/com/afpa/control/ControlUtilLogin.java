...
public class ControlUtilLogin implements Serializable {
    ...
    public void logIn() {
        ...
        try {
            ...
            //System.out.println("pseudo : "+u.getPseudo()+"|mdp:"+u.getMotdepasse());
        ...
        u = adb.readUtlitisateurByPseudo(u.getPseudo());
    }
    ...
    public void show() {
        ...
        if (request.getUserPrincipal() == null) {
            ...
            try {
                context.getExternalContext().redirect("accueil.xhtml");// je redirige vers l'accueil
